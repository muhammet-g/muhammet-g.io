...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function updateCities() {
    ...
    // Create the default "اختر مدينة" option
    const defaultOption = document.createElement("option");
    defaultOption.value = "";
    defaultOption.textContent = "اختر مدينة";
    ...
    // Get the cities array for the selected country
    const cities = arabCountriesData[selectedCountry];

    // Populate the city select with the new cities
    cities.forEach((city) => {
